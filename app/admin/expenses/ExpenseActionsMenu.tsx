...
export default function ExpenseActionsMenu({ expense }: { expense: Expense }) {
  ...
  return (
    <>
            ...
            >
              {confirmingDelete ? (
                <div className="px-3.5 py-2.5">
                  <p className="mb-2 text-xs text-ink-soft">Delete this expense?</p>
      ...
      {editing && <EditExpensePanel expense={expense} onClose={() => setEditing(false)} />}
    </>
  );
}
